  ...
  return {
    ...
    divisionalCharts: {
      ...
      10: {
        ...
        label: "D10",
        description: "Career",
        positions: [{ name: "Saturn", rashi_sign: "Capricorn", divisional_sign: "Capricorn", part_index: 0, degree_in_divisional_sign: 0 }],
      },
      ...
      const evidence = extendedEvidence({
        divisionalCharts: {
          ...
          7: {
            ...
            label: "D7",
            description: "Lineage",
            positions: [{ name: "Jupiter", rashi_sign: "Cancer", divisional_sign: "Cancer", part_index: 0, degree_in_divisional_sign: 0 }],
          },
          12: { division: 12, label: "D12", description: "Ancestry", positions: [] },
        },
      });
